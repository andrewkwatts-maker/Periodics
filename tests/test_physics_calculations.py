...
from utils.physics_calculator_v2 import (
    SubatomicCalculatorV2,
    AtomCalculatorV2,
    MoleculeCalculatorV2,
    PhysicsConstantsV2
)
from utils.physics_calculator import MoleculeCalculator
from utils.alloy_calculator import AlloyCalculator
...
class DataLoader:
    ...
    BASE_PATH = Path(__file__).parent.parent / "data" / "defaults"
