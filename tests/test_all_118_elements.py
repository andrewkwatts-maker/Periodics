...
from utils.simulation_schema import propagate_hadrons_to_atom
...
def run_all_118_element_tests():
    ...
    for i, (Z, element_data) in enumerate(sorted(elements.items())):
        ...
        result = test_element(element_data, proton_data, neutron_data)
...
class TestAll118Elements(unittest.TestCase):
    ...
    def test_atomic_mass_accuracy(self):
        ...
        for Z, element_data in sorted(self.elements.items()):
            result = test_element(element_data, self.proton_data, self.neutron_data)
    ...
    def test_light_elements_accuracy(self):
        ...
        for Z in range(1, 21):
            ...
            result = test_element(self.elements[Z], self.proton_data, self.neutron_data)
